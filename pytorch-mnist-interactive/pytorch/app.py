...
from .model import Net  # Ensure this import is correct
...
print(f"Image path: {args.image}")  # Debugging print statement

# Make Prediction
# Load model
model_path = os.path.join(package_dir, 'model')  # Change to the correct path
model = Net()
